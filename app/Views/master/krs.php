                                ...
                                <div class="tab-pane fade" id="profile" role="tabpanel" aria-labelledby="profile-tab">
                                    ...
                                    <div class="form container">
                                        ...
                                        <div class="form-check">
                                            <input class="form-check-input checkAll01" onclick="checkAll01(this.checked);" type="checkbox" id="checkAll01" name="checkAll01" value="#">
    ...
    $(document).ready(function() {
        ...
        function proses_update() {
            ...
            if (NO < PRODI_AKT.length) {
                ...
                $.ajax({
                    url: "<?= site_url('master/do-import-krs'); ?>",
                    type: "POST",
                    dataType: "json",
                    data: {
                        prodi: prodi,
...
<script>
    ...
    function dataTabel(prodi = $(".filter-prd").val(), periode = $(".filter-smt").val()) {
        ...
        $('#table-10').DataTable({
            destroy: true,
            "ajax": {
                url: "<?= base_url('dinamis/load-mstr-pesertakls'); ?>",
                type: "POST",
                data: {
                    prodi: prodi,
                    periode: periode
