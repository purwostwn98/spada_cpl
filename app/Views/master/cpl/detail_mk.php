...
<div class="main-content">
    <section class="section">
        <div class="section-header bg-warning">
            <h1 class="text-primary">Detil Mata Kuliah</h1>
                                    ...
                                    <div class="row">
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <select class="form-control filter_thn" onchange="loadMk()">
                                        ...
                                        <div class="col-md-8">
                                            <div class="form-group">
                                                ...
                                                <select class="form-control select2 filter-prd" onchange="loadMk()">
                                                        ...
                                                        <table class="table table-striped" id="table-10">
                                                            <thead>
                                                                <tr>
                                                                    ...
                                                                    <th width="50%">Nama</th>
                                                                    <th width="10%">SKS</th>
                                                                    <th width="10%">Tahun Kurikulum</th>
                                                                    <th width="10%">Aksi</th>
                                                                </tr>
                                                            </thead>
                                                            <tbody>
    ...
    $(document).ready(function() {
        ...
        function proses_update() {
            ...
            if (NO < PRODI_AKT.length) {
                ...
                $.ajax({
                    url: "<?= site_url('master/do-import-detilmk'); ?>",
                    type: "POST",
                    dataType: "json",
                    data: {
                        prodi: prodi,
...
<script>
    function loadMk() {
        ...
        var tahun = $(".filter_thn").val();

        dataTabel(prodi, tahun);
    }


    function dataTabel(prodi = $(".filter-prd").val(), tahun = $(".filter_thn").val()) {
        nomor = 0;
            ...
            "columns": [{
                ...
                },
                {
                    ...
                    "mRender": function(data, type, full) {
                        return '<button value="' + full['id_mk'] + '" class="btn btn-sm btn-info" onclick="lihatCPMK(this.value);">Detil</button>';
                    },
                }
            ],
        })
